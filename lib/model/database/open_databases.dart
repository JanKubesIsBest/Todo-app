...
Future<void> createTodoTable(Database db) {
  ...
  return db.execute(
    ...
    'CREATE TABLE todos(id INTEGER PRIMARY KEY, name TEXT, description TEXT, created STRING, channelId INT, deadlineId int, isRecuring int, durationOfRecuring int, done int)',
  );
}
